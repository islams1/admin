...
# =========================================================
# التبويب الأول: الموقف التدريبي العام (محدث بالإضافات الجديدة)
# =========================================================
with tab1:
    ...
    # الشكل الأول: إجمالي المسجلين (قيادة vs مركبات)
    with row_new_1:
    ...
    # الشكل الثاني: المسارات التدريبية الأكثر حجزاً
    with row_new_2:
    ...
    with row_drill_1:
        st.subheader("📍 توزيع المخالفات حسب المنطقة")
    ...
    # --- 4. مخطط الأداء (خطوط منقطة ومتصلة) ---
    ...
    fig3 = go.Figure()
    # الخط الأول: عدد المخالفات (منقط - أحمر)
    ...
    # الخط الثاني: عدد من حجزوا الدورات (متصل - ذهبي)
...
# =========================================================
# التبويب الثاني: ملف المتدرب (محفوظ كما هو تماماً)
# =========================================================
with tab2:
    ...
    if trainee_id:
        ...
        # تقسيم الشاشة لجزئين: المخالفات المرتبطة + جدول الحضور
